...
#define  HAVE_CURLOPT_TCP_KEEPALIVE 1
#define  HAVE_CURLOPT_TCP_KEEPIDLE 1
#define  HAVE_CURLOPT_TCP_KEEPINTVL 1
...
#define  HAVE_CURLPROXY_SOCKS5_HOSTNAME 1
...
#define  HAVE_CURLOPT_NOSIGNAL 1
...
#define  HAVE_CURLOPT_HAPROXYPROTOCOL 1
...
#define  HAVE_CURLOPT_PROXYHEADER 1
...
#define  HAVE_CURL_SSLVERSION_TLSV1_0 1
#define  HAVE_CURL_SSLVERSION_TLSV1_1 1
#define  HAVE_CURL_SSLVERSION_TLSV1_2 1
...
#define  HAVE_CURLE_FTP_PRET_FAILED 1
#define  HAVE_CURLE_RTSP_CSEQ_ERROR 1
#define  HAVE_CURLE_RTSP_SESSION_ERROR 1
#define  HAVE_CURLE_FTP_BAD_FILE_LIST 1
#define  HAVE_CURLE_CHUNK_FAILED 1
#define  HAVE_CURLE_NO_CONNECTION_AVAILABLE 1
#define  HAVE_CURLE_SSL_PINNEDPUBKEYNOTMATCH 1
#define  HAVE_CURLE_SSL_INVALIDCERTSTATUS 1
#define  HAVE_CURLE_HTTP2_STREAM 1
