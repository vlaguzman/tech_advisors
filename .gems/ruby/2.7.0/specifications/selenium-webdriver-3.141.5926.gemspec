# -*- encoding: utf-8 -*-
# stub: selenium-webdriver 3.141.5926 ruby lib

Gem::Specification.new do |s|
  s.name = "selenium-webdriver".freeze
  s.version = "3.141.5926"
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<childprocess>.freeze, [">= 0.5", "< 2.0"])
    ...
    s.add_dependency(%q<childprocess>.freeze, [">= 0.5", "< 2.0"])
